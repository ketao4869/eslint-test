...
module.exports = {
	...
	prompt: {
		...
		types: [
			{ value: 'feat', name: '特性|feat:		✨  一个新功能', emoji: ':sparkles:' },
			{ value: 'fix', name: '修复|fix:		🐛  一个 bug 修复', emoji: ':bug:' },
			...
			{ value: 'build', name: '构建|build:		📦️   构建流程、外部依赖变更（如升级 npm 包、修改 webpack 配置等）', emoji: ':package:' },
